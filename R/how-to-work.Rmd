...
2. Copy the files your are working on as `file-name_your-name.Rmd`.
...
5. After completing each task, commit your work with a meaningful message, and update your pull request with `usethis::pr_sync()`.
